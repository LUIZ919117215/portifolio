...
export function Menu() {
   return (
      <>
         <section className="h-[94vh] w-[67vw] flex flex-col justify-between bg-base-primary backdrop-blur-sm rounded-md border-[1.1px] border-slate-300 shadow-main md:flex-row-reverse">
            <Outlet/>
